...
df.iris$dbscan.cmeans.ecs = element_sim_elscore(disjoint.clustering, 
                                                soft.clustering)
...
df.iris$dbscan.hc.ecs = element_sim_elscore(disjoint.clustering, 
...
df.iris$cmeans.hc.ecs = element_sim_elscore(soft.clustering, 
                                            hierarchical.clustering)
